...
<div class="content-wrapper">
  ...
  <input type="hidden" name="_token" value="{{ csrf_token() }}" />
								<div class="form-group">
								    ...
								    <input type="text" class="form-control"  id="email" rows="1"  name="email">
								</div>
								<div class="form-group">
								<label for="exampleInputRef"> Référence </label>
								<input type="text" class="form-control" id="reference" placeholder=" n° Reference" name="reference">
							  </div>
                        ...
                        <table class="table">
                          <thead>
                            <tr>
                              ...
                              <th>Nom & prenom</th>
                              <th>Télephone</th>
                              <th>Text /Zone(s) /Num(s) /N°sponso /Montant/N° Ref/statut</th>
